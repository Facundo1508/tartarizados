...
$url_API = "80.35.251.17/cgi-vel/vnvm/api.pro?w_as=5684|ART_BUS|GET|100|1|1|1|Publicable|300|400";
    ...
    foreach($registros as $registros) {
        ...
        if ($getSku) {
            ...
            continue;
                ...
                print_r($registros->nombre);
                
                $data = [
                    'name' => $registros->nombre,
                    'type' =>  "simple",
                    'regular_price' => '212',
                    'description' => $registros->metaDescripcion,
